package com.example.djshichaoren.googleocrtest2.subtitle_api.utils;
...
import com.example.djshichaoren.googleocrtest2.subtitle_api.subtitle.common.TimedObject;
import com.example.djshichaoren.googleocrtest2.subtitle_api.subtitle.config.Font;
import com.example.djshichaoren.googleocrtest2.subtitle_api.subtitle.config.SimpleSubConfig;
...
public class ConvertionUtils {
	...
	public static V4Style createV4Style(SimpleSubConfig config) {
		...
		style.setPrimaryColour(ColorUtils.hexToRGB(font.getColor()));
		style.setOutlineColor(ColorUtils.hexToRGB(font.getOutlineColor()));
