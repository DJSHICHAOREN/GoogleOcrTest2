...
//    private JinshanTranslation.Exchange exchange;

    private List<JinshanTranslation.Symbol> symbols;


    public List<JinshanTranslation.Symbol> getSymbols() {
        return symbols;
    }

    public void setSymbols(List<JinshanTranslation.Symbol> symbols) {
        this.symbols = symbols;
    }

//    public JinshanTranslation.Exchange getExchange() {
//        return exchange;
//    }
//
//    public void setExchange(JinshanTranslation.Exchange exchange) {
...
//    }
    ...
    public class Symbol{
        ...
        public List<JinshanTranslation.Symbol.Part> parts;
        ...
        public List<JinshanTranslation.Symbol.Part> getParts() {
            return parts;
        }

        public void setParts(List<JinshanTranslation.Symbol.Part> parts) {
            this.parts = parts;
        }
    ...
    public TranslateResult(JinshanTranslation jinshanTranslation){
        ...
        if(jinshanTranslation.getSymbols() != null
            ...
            short_translation = jinshanTranslation.getSymbols().get(0).getParts().get(0).getMeans().get(0);
        }


        this.word_name = jinshanTranslation.getWord_name();
        this.symbols = jinshanTranslation.getSymbols();
//        this.exchange = jinshanTranslation.getExchange();
